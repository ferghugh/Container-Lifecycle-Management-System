...
// Approvals component that fetches and displays pending approvals, allowing users to approve them.
...
// Function to approve a specific approval request by its ID
